...
@api channelPartnerId;
@api channelPartnerName;
@api makeItReadOnly = false;
preventClosingOfSerachPanel = false;
previousChannelPartnerId;
setReadonly  = false;
get methodInput() {
...
connectedCallback() {
     this.selectedRecordId= this.channelPartnerId,
     this.previousChannelPartnerId=this.channelPartnerId,
      this.selectedRecordName = this.channelPartnerName,
...
this.selectedRecordName = result[0].mainField;
            } console.log('result[0].mainField----'+result[0].mainField);
